...
public class FindColleagueFragment extends Fragment {

    private FragmentFindColleagueBinding binding;

    public FindColleagueFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFindColleagueBinding.inflate(inflater, container, false);
